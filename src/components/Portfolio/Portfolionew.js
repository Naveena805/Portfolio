...
const Portfolionew = () => {
  ...
  <a className="navbar-brand container-fluid " href="#home"><img  className='imdrop container-fluid' src='im10.png'  /></a>
...
<div className="card container-fluid bg-transparent" style={{width: '20rem',height:'32rem',top:'100px'}} >
  <img src="navee.jpg" className="card-img-top rounded" alt="..." style={{width: '100px',height:'150px',marginLeft:'90px'}}/>
  <div className="card-body">
    <h3 className="card-title" style={{textAlign:'center',color:'white'}}>NAVEENA V <img src='result1.gif' style={{backgroundColor:'transparent',width:'300PX',marginLeft:'-10PX'}}/></h3>
    <p className="card-text"> <nav><a href='https://www.instagram.com/accounts/login/'> <img src='download1.png' ait='' className='rounded' style={{height:'30px',width:'30px' ,marginLeft:'50PX'}}></img></a><a href='https://www.linkedin.com/'><img src='download3.png' className='rounded-circle' style={{height:'30px',width:'30px' ,marginLeft:'30px'}}></img></a><a href='https://twitter.com/i/flow/login'><img src='download 2.jpg' className='rounded-circle'
  ...
  <a className="navbar-brand " href="#home"><img className='imdrop' src='im10.png' ></img></a>
